...
namespace MrFrozo.Pages
{
    ...
    public sealed partial class MathAdditionPage : Page
    {
        ...
        private void PopulateQuestion()
        {
            ...
            this.txtAnswer1.ClearValue(TextBox.TextProperty);
            this.txtAnswer2.ClearValue(TextBox.TextProperty);
            this.txtAnswer3.ClearValue(TextBox.TextProperty);
            this.txtAnswer4.ClearValue(TextBox.TextProperty);
            this.txtAnswer5.ClearValue(TextBox.TextProperty);
